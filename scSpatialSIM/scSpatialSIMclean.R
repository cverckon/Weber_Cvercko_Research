...
sim_obj_1i <- sim_obj_1
sim_obj_2i <- sim_obj_2

sim_obj_1 <- sim_obj_1i
sim_obj_2 <- sim_obj_2i

sim_obj_1

ExtractParameters(sim_obj_1, steps = 'Cells')$Cells$'Cell Type 1'$k
SummariseSpatial(sim_obj_1)
